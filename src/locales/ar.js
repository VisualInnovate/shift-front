export default {
  authPasswordReset: {
    ...
    forgotDescription: 'أدخل بريدك الإلكتروني للمتابعة في إعادة تعيين كلمة المرور.',
    emailLabel: 'البريد الإلكتروني',
    requiredEmail: 'البريد الإلكتروني مطلوب.',
    invalidEmail: 'يرجى إدخال بريد إلكتروني صحيح.',
    sendResetCode: 'متابعة',
    backToLogin: 'العودة لتسجيل الدخول',
    resetTitle: 'إعادة تعيين كلمة المرور',
    resetDescription: 'سنرسل رمز التحقق إلى {email}.',
    readonlyEmail: 'البريد الإلكتروني',
    otpLabel: 'رمز التحقق',
    otpDigit: 'رقم الرمز {number}',
    otpHelp: 'أدخل الرمز المكون من 6 أرقام والمرسل إلى بريدك الإلكتروني.',
    ...
    otpSentError: 'فشل إرسال رمز التحقق.',
    changeSuccess: 'تم تغيير كلمة المرور بنجاح.',
    changeError: 'فشل تغيير كلمة المرور.',
    invalidOtp: 'أدخل رمز تحقق صحيحًا مكونًا من 6 أرقام.',
    requiredFields: 'يرجى ملء جميع الحقول المطلوبة.',
    passwordMismatch: 'كلمتا المرور غير متطابقتين.',
    missingEmail: 'البريد الإلكتروني غير موجود في رابط إعادة التعيين.',
  ...
  order: {
    ...
    proc: {
      ...
      cancelled: 'ملغي',
      overdueTitle: 'تأخر في التحضير',
      overdueDesc: 'مضى أكثر من 25 دقيقة على بدء تحضير هذا الطلب دون تحديث.',
      notYet: 'لم يتم بعد',
      minutes: 'دقيقة',
    },
    overdueBy: 'متأخر ',
    ...
    pending: 'قيد الانتظار',
    management: 'تتبع الطلبات',
    realTimeUpdates: 'مراقبة مباشرة لخط سير الطلبات',
    ...
    statusProcessed: 'تم التجهيز',
    statusDelivering: 'جاري التوصيل',
    statusCompleted: 'تم الاستلام',
    processing: 'قيد التحضير ',
    ready: 'جاهز',
    shipped: 'تم الشحن',
    delivered: 'تم التسليم',
    ...
    invoiceConfirmationMessage:
      'هل أنت متأكد من المتابعة في إنشاء الفاتورة الرسمية لهذا الطلب؟ قد يكون هذا الإجراء غير قابل للإلغاء.',
    ...
    confirmInvoice: 'تأكيد إصدار الفاتورة',
    selectFirst: 'الرجاء اختيار طلب أولاً',
  ...
  settings: {
    ...
    order_notification_emails: 'رسائل إشعار الطلب',
    order_notification_emailsPlaceholder: 'أدخل بريدًا إلكترونيًا للإشعار ثم اضغط إضافة',
    order_notification_emailsEmpty: 'لم يتم إضافة أي بريد إلكتروني لإشعارات الطلب بعد.',
    invalidEmail: 'بريد إلكتروني غير صالح',
    invalidEmailDetail: 'يرجى إدخال بريد إلكتروني صالح',
    duplicateEmail: 'البريد الإلكتروني مكرر',
    duplicateEmailDetail: 'هذا البريد الإلكتروني مضاف بالفعل',
  ...
  cart: {
    ...
    currency: 'د.أ',
    export: 'تصدير',
    filterEndDate: 'تصفية حسب تاريخ الانتهاء',
    filterStartDate: 'تصفية حسب تاريخ البدء',
    filterStatus: 'تصفية حسب الحالة',
    orderSummary: 'ملخص الطلب الكلي',
    paymentMethod: 'طريقة الدفع',
    cashOnDelivery: 'الدفع نقدًا عند الاستلام',
    cashOnDeliveryDescription: 'ادفع نقدًا عند استلام طلبك.',
    payWithCliq: 'الدفع عبر CliQ',
    payWithCliqDescription: 'سنزودك بالاسم المستعار بعد إتمام الطلب.',
    creditCard: 'بطاقة ائتمانية',
    creditCardDescription: 'الدفع بالبطاقة عند الاستلام.',
    creditCardInAppDescription: 'ادفع مباشرة داخل التطبيق باستخدام بطاقتك الائتمانية.',
    comingSoon: 'قريبًا',
  ...
  orders: {
    hasSubstitutesForThisItem: 'بتوفر بدائل لهذا المنتج',
    hasSubstitutes: 'بعض المنتجات في طلبك غير متوفرة، يمكنك اختيار بدائل لها.',
    chooseAlternative: 'اختر بديلًا',
    alternativesForItem: 'البدائل المتاحة',
    originalProduct: 'المنتج الأصلي',
    variantPrice: 'السعر',
    selectAlternative: 'اختر أحد البدائل',
    saveSelection: 'حفظ',
    removeFromOrder: 'حذف هذا المنتج من الطلب',
    substituteSelected: 'تم اختيار البديل بنجاح.',
    substituteRemoved: 'تم حذف المنتج من الطلب.',
    substituteActionError: 'حدث خطأ أثناء تحديث هذا المنتج.',
    orderItemUnavailable: 'هذا المنتج غير متوفر.',
    alternativeAvailable: 'بدائل متاحة',
    title: 'طلباتي',
    ...
    title: 'إدارة طلباتك',
    subtitle: 'إدارة ومتابعة دورة الطلبات الواردة الخاصة بك.',
    totalCount: 'إجمالي عدد الطلبات',
    orderNumber: 'رقم الطلب',
    items: 'منتجات',
    ...
    quantity: 'الكمية',
    subtotal: 'المجموع الفرعي',
    paymentSummary: 'تفاصيل الفاتورة',
    subtotalCost: 'تكلفة المجموع الفرعي',
    taxationFee: 'قيمة الضريبة',
    serviceSurcharge: 'رسوم الخدمة',
    shippingLogistics: 'تكلفة الشحن والتوصيل',
    couponApplied: 'خصم الكوبون المطبق',
    markdownFees: 'الخصومات والتنزيلات الإضافية',
    grandTotal: 'المجموع الكلي',
    notes: 'ملاحظات الطلب',
    retry: 'إعادة تحميل الطلبات',
    noOrders: 'لا توجد طلبات مسجلة',
    emptySubtitle: 'يبدو أنك لم تقم بإجراء أي عمليات شراء بعد.',
    noOrdersAvailable: 'لا توجد أي طلبات متوفرة في حسابك حالياً.',
    loadError: 'فشل تحميل سجل طلباتك. يرجى التحقق من الاتصال بالشبكة.',
    statusUnknown: 'حالة غير معروفة',
    previous: 'السابق',
    next: 'التالي',
  },
  ...
  market: {
    ...
    closeStore: 'إغلاق السوق',
    closeError: 'فشل في إغلاق السوق',
    timeslots: 'أوقات العمل',
    day: 'اليوم',
    selectDay: 'اختر اليوم',
    startTime: 'وقت البدء',
    endTime: 'وقت الانتهاء',
    addTimeslot: 'إضافة',
    noTimeslots: 'لم تتم إضافة أيام عمل',
    allDaysAdded: 'تمت إضافة جميع أيام الأسبوع لهذا السوق.',
    timeslotLoadError: 'فشل في تحميل أوقات العمل',
    timeslotValidationError: 'اختر اليوم وساعات عمل صحيحة.',
    timeslotDuplicateError: 'هذا اليوم لديه وقت عمل بالفعل.',
    timeslotCreatedSuccess: 'تم إنشاء وقت العمل بنجاح',
    timeslotCreateError: 'فشل في إنشاء وقت العمل',
    timeslotDeletedSuccess: 'تم حذف وقت العمل بنجاح',
    timeslotDeleteError: 'فشل في حذف وقت العمل',
  ...
  templateNotification: {
    showTitle: 'عرض الاشعارات',
    createTemplateNotification: 'انشاء قالب اشعار',
    createTitle: 'انشاء قالب اشعار جديد',
    createError: 'فشل في انشاء قالب الاشعار',
    createSuccess: 'تم انشاء قالب الاشعار بنجاح',
    deleteError: 'فشل في حذف قالب الاشعار',
    deleteSuccess: 'تم حذف قالب الاشعار بنجاح',
    confirmDeleteTitle: 'تاكيد الحذف',
    confirmDeleteMessage: 'هل انت متاكد من حذف هذا القالب؟',
    ...
    useTemplate: 'استخدام قالب موجود',
    customNotification: 'إشعار مخصص',
    selectTemplate: 'اختر القالب',
    selectTemplatePlaceholder: 'اختر قالبًا من القائمة',
  },
  error: 'خطأ',
  success: 'نجاح',
  show: 'عرض',
  ...
  store: {
    ...
    addTimeslot: 'إضافة',
    noTimeslots: 'لم تتم إضافة أيام عمل',
    allDaysAdded: 'تمت إضافة جميع أيام الأسبوع لهذا المتجر.',
    timeslotLoadError: 'فشل في تحميل أوقات العمل',
    timeslotValidationError: 'اختر اليوم وساعات عمل صحيحة.',
    timeslotDuplicateError: 'هذا اليوم لديه وقت عمل بالفعل.',
    timeslotCreatedSuccess: 'تم إنشاء وقت العمل بنجاح',
  ...
  product: {
    ...
    priceUpdateInfo:
      "قم بتحميل ملف CSV يحتوي على 'معرّف المنتج' و 'السعر الأساسي' و 'سعر التكلفة' لتحديث الأسعار بالجملة.",
  ...
  discount: {
    ...
    variant_hint:
      'يمكنك اختيار متغير منتج معين لتطبيق الخصم عليه. إذا لم يتم اختيار أي متغير، فسيتم تطبيق الخصم على جميع المتغيرات للمنتج المحدد.',
  ...
  auth: {
    ...
    loginnote: ' الرجاء ادخال معلومات الدخول  الخاصة بك لتسجيل الدخول الي حسابك',
    email: 'البريد الالكتروني',
  ...
  followUsPage: {
    followUs_p:
      'يوفر Shift 7 كل ما تحتاجه تحت سقف واحد - من الأجهزة الإلكترونية والألعاب إلى مستحضرات التجميل والعناية الشخصية. استمتع بالتسليم السريع والدفع الآمن وراحة التسوق في أي وقت وفي أي مكان.',
    infoP:
