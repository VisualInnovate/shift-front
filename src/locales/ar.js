...
export default {
  ...
  custom_tabs: {
    ...
    "type": "النوع",
    "select_type": "اختر النوع",
    "type_required": "اختيار النوع مطلوب.",
    "categories": "الفئات",
    "products": "المنتجات",
    "brands": "الماركات",
    ...
    "add_detail": "إضافة التفصيل",
    "fill_all_fields": "يرجى ملء جميع الحقول المطلوبة بشكل صحيح.",
    "detail_added": "تمت إضافة التفصيل بنجاح!",
    "add_failed": "فشل في إضافة التفصيل.",
    "details": "التفاصيل",
    "no_details": "لم يتم العثور على تفاصيل لهذا التبويب. أضف واحداً أعلاه!",
    "edit_detail": "تعديل التفصيل",
    "optional_reupload": "إعادة تحميل اختيارية",
    "leave_empty_to_keep": "اترك فارغاً للاحتفاظ بالصورة الحالية.",
    ...
    "details_load_failed": "فشل في تحميل تفاصيل التبويب المخصص.",
    "items_load_failed": "فشل في تحميل العناصر المتاحة.",
    "confirm_delete": "تأكيد الحذف",
    "confirm_delete_message": "هل أنت متأكد من أنك تريد حذف هذا التفصيل؟ لا يمكن التراجع عن هذا الإجراء.",
    "detail_deleted": "تم حذف التفصيل بنجاح!",
    "delete_failed": "فشل في حذف التفصيل.",
    update_failed: 'فشل في تحديث التفصيل',
    id_1: 'المعرف 1',
