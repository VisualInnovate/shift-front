export default {
  ...
  user: {
    ...
    resetPassword: {
      ...
      dialogSubtitle: 'Confirm the reset code',
      dialogDescription: 'Enter the OTP sent to this email, then set a new password.',
      emailLabel: 'Email address',
      otpLabel: 'OTP code',
      otpHelp: 'Enter the 6-digit code sent to the email.',
