export default {
  ...
  authPasswordReset: {
    ...
    forgotDescription: 'Enter your email to continue resetting your password.',
    emailLabel: 'Email address',
    requiredEmail: 'Email is required.',
    invalidEmail: 'Please enter a valid email address.',
    sendResetCode: 'Continue',
    backToLogin: 'Back to login',
    resetTitle: 'Reset Password',
    resetDescription: 'We will send a verification code to {email}.',
    readonlyEmail: 'Email address',
    ...
    otpSentError: 'Failed to send verification code.',
    ...
    missingEmail: 'Email is missing from the reset link.',
  ...
  from: 'of',
  orders: {
    hasSubstitutesForThisItem: 'Substitutes available for this item',
    hasSubstitutes: 'Some products in your order are unavailable. You can choose alternatives for them.',
    chooseAlternative: 'Choose an alternative',
    alternativesForItem: 'Available alternatives',
    originalProduct: 'Original product',
    variantPrice: 'Price',
    selectAlternative: 'Select an alternative',
    saveSelection: 'Save',
    removeFromOrder: 'Remove this product',
    substituteSelected: 'Alternative selected successfully.',
    substituteRemoved: 'The product was removed from the order.',
    substituteActionError: 'Something went wrong while updating this item.',
    orderItemUnavailable: 'This product is unavailable.',
    alternativeAvailable: 'Alternative available',
    title: 'My Orders',
    orderNumber: 'Order #',
    items: 'items',
    item: 'item',
  ...
  order: {
    ...
    invoiceConfirmationMessage:
      'Are you sure you want to proceed with generating the official invoice for this order? This action may be irreversible.',
  ...
  settings: {
    ...
    phone: 'Phone Number',
    order_notification_emails: 'Order Notification Emails',
    order_notification_emailsPlaceholder: 'Enter notification email and click add',
    order_notification_emailsEmpty: 'No notification emails added yet.',
    ...
    invalidEmailDetail: 'Enter a valid email address',
    duplicateEmail: 'Duplicate email',
    duplicateEmailDetail: 'This email is already added',
  },
  common: {
    id: 'ID',
    name: 'Name',
  ...
  market: {
    ...
    closeError: 'Error closing market',
    ...
    endTime: 'End Time',
    addTimeslot: 'Add',
    noTimeslots: 'No working days added',
    allDaysAdded: 'All week days have been added for this market.',
    timeslotLoadError: 'Failed to load time slots',
    timeslotValidationError: 'Select a day and valid working hours.',
    timeslotDuplicateError: 'This day already has a time slot.',
    timeslotCreatedSuccess: 'Time slot created successfully',
    timeslotCreateError: 'Failed to create time slot',
    timeslotDeletedSuccess: 'Time slot deleted successfully',
    timeslotDeleteError: 'Failed to delete time slot',
  ...
  templateNotification: {
    ...
    cancel: 'Cancel',
    save: 'Save',
    showTitle: 'View Notification',
    createTemplateNotification: 'Create Template',
    ...
    confirmDeleteMessage: 'Are you sure you want to delete this template?',
    ...
    yesAllUsers: 'Yes, send to all users',
    selectUsers: 'Select Users',
    searchUsers: 'Search and select users',
    ...
    selectTemplatePlaceholder: 'Choose a template from the list',
  },
  shiftmart: {
    title: 'ShiftMart File Management',
  ...
  cart: {
    ...
    payWithCliqDescription: 'We will provide the alias after your order is placed.',
    creditCard: 'Credit card',
    creditCardDescription: 'Pay by card at delivery.',
    creditCardInAppDescription: 'Pay directly in the app using your credit card.',
  ...
  store: {
    ...
    addTimeslot: 'Add',
    noTimeslots: 'No working days added',
    allDaysAdded: 'All week days have been added for this store.',
    timeslotLoadError: 'Failed to load time slots',
    timeslotValidationError: 'Select a day and valid working hours.',
    timeslotDuplicateError: 'This day already has a time slot.',
    timeslotCreatedSuccess: 'Time slot created successfully',
  ...
  product: {
    ...
    priceUpdateInfo:
      "Upload a CSV file containing the product 'id', 'base_price', and 'cost_price' to update prices in bulk.",
  ...
  followUsPage: {
    followUs_p:
      'Shift 7 brings everything you need under one roof – from electronics and toys to cosmetics and personal care. Enjoy fast delivery, secure payments, and the convenience of shopping anytime, anywhere.',
    infoP:
