  ...
  >
    <div class="bg-white rounded-3xl shadow-2xl p-4 w-full max-w-sm sm:max-w-lg my-8">
      ...
      <form @submit.prevent="handleLogin" v-if="selectedTab === 'phone'" class="space-y-6">
        ...
        <div class="relative">
          <input
            ...
            class="w-full px-4 py-3 pr-12 rounded-xl bg-gray-100 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-shadow"
            :class="{ 'text-right': $i18n.locale === 'ar', 'text-left': $i18n.locale !== 'ar' }"
            required
            minlength="8"
          />
        ...
        <div :class="{ 'text-left': $i18n.locale !== 'ar', 'text-right': $i18n.locale === 'ar' }">
          <a @click="router.push({ name: 'forgetpassword' })" class="text-blue-600 font-medium hover:underline cursor-pointer">
      ...
      <form @submit.prevent="handleLogin" v-else class="space-y-6">
        ...
        <div :class="{ 'text-left': $i18n.locale !== 'ar', 'text-right': $i18n.locale === 'ar' }">
          <a @click="router.push({ name: 'forgetpassword' })" class="text-blue-600 cursor-pointer font-medium hover:underline">
            {{ t('login.forgotPassword') }}
          </a>
        </div>
      ...
      >
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            <path
              d="M488 261.2c0-14.7-1.4-29.1-4.1-43.1H256v82.2h135.5c-5.7 29.8-22.3 55.4-46.1 73.1v53.4h68.8c40.3-37.1 63.5-91.8 63.5-165.6z"
              fill="#4285f4"
            ></path>
            <path
              d="M256 496c69.8 0 128.4-22.9 171.2-62.5l-68.8-53.4c-19.1 13.5-44.5 21.6-76.4 21.6-58.6 0-108.4-39.6-126.3-92.4H68.8v53.4C106.8 447.2 176.6 496 256 496z"
              fill="#34a853"
            ></path>
            <path
              d="M129.7 302.5c-3.1-9.2-4.9-19-4.9-29.2s1.8-19.9 4.9-29.2V190H68.8c-10.2 20.3-15.8 43.8-15.8 68.8s5.6 48.5 15.8 68.8L129.7 302.5z"
              fill="#fbbc04"
            ></path>
            <path
              d="M256 106.8c34.8 0 65.9 12 90.3 35.5l61.2-61.2c-38.3-36.4-88.6-58.1-151.5-58.1-79.4 0-149.2 48.8-187.2 122.8l61.2 47.5c17.9-52.8 67.7-92.4 126.3-92.4z"
              fill="#ea4335"
            ></path>
          </g>
        </svg>
...
// Updated countries array with English names
const countries = [
...
const handleLogin = async () => {
  ...
  const data = selectedTab.value === 'phone'
    ? { type: 'phone', phoneNumber: phoneNumber.value, password: password.value, countryCode: countryCode.value }
    : { type: 'email', email: email.value, password: password.value };
...
<style scoped>
/* Ensure RTL text alignment for inputs and select */
[dir="rtl"] .text-right {
  text-align: right;
}
