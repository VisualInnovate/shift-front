<template>
  ...
  <main class="min-h-[100vh]">
    <header>
      ...
      <swiper :modules="[Autoplay, Navigation]" :slides-per-view="5" :space-between="25" :loop="true"
        :autoplay="{ delay: 3000, disableOnInteraction: false }" :speed="3000" :navigation="false" grab-cursor
        class="h-[58px] mt-2" :breakpoints="{
...
useHead({
  ...
  link: [{ rel: 'canonical', href: 'https://www.shift7store.com/' }],
})
