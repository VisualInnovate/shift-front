        ...
        <div class="col-12">
            <div class="card p-4 shadow-2 border-round">
                    ...
                    <template #end>
                        <div class="flex gap-2 align-items-center">
                            ...
                            <Dropdown v-model="selectedCategory" :options="categories" optionLabel="label" optionValue="value"
                                :placeholder="t('product.categoryFilter')" class="w-12rem" :showClear="true" filter @filter="onCategoryFilter" />
                            ...
                            <Dropdown v-model="selectedMarket" :options="markets" optionLabel="label" optionValue="value"
                                :placeholder="t('product.marketFilter')" class="w-12rem" :showClear="true" filter @filter="onMarketFilter" />
                            ...
                            <Button v-can="'create products'" :label="t('product.new')" icon="pi pi-plus"
                                class="p-button-success" @click="createNewProduct" />
                        </div>
                    </template>
                </Toolbar>
                ...
                <div class="card shadow-1 surface-0">
                    <DataTable :value="products" :loading="loading" data-key="id" responsive-layout="scroll"
                        ...
                        <Column :header="t('product.freeShipping')">
                            <template #body="slotProps">
                                <div class="flex justify-content-center align-items-center">
                                    ...
                                    />
                                    <ProgressSpinner v-if="toggleLoading[slotProps.data.id]"
                                        style="width: 20px; height: 20px" class="ml-2" strokeWidth="5" />
                                </div>
                            </template>
                        </Column>
                        ...
                        <Column :header="t('product.bestSeller') || 'Best Seller'">
                            <template #body="slotProps">
                                <div class="flex justify-content-center align-items-center">
                                    <InputSwitch
                                        :model-value="slotProps.data.is_best_seller"
                                    ...
                                    />
                                    <ProgressSpinner v-if="toggleBestSellerLoading[slotProps.data.id]"
                                        style="width: 20px; height: 20px" class="ml-2" strokeWidth="5" />
                                </div>
                            </template>
                        </Column>
                    ...
                    <div class="p-paginator p-component p-unselectable-text p-paginator-bottom">
                        ...
                        <div class="p-paginator-right-content">
                            ...
                            <Dropdown v-model="rowsPerPage" :options="[5, 10, 20, 30]" @change="changeRowsPerPage"
                ...
                <Dialog v-model:visible="priceUpdateDialog" :style="{ width: '450px' }" :header="t('product.updatePriceTitle')" :modal="true">
                    <div class="flex flex-column gap-3">
                        <Button :label="t('product.downloadPriceExample')" icon="pi pi-download" class="p-button-outlined p-button-warning"
...
:deep(.p-datatable) { font-size: 0.9rem; }
